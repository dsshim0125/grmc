...
class ResNet(nn.Module):
    def __init__(self, layers = 50, decoder = 'upproj', output_size=(240, 320), in_channels=3):
...
class MoCo(nn.Module):
    ...
    """
    def __init__(self, dim=256, K=65536, m=0.999, T=0.07, layers=50):
        """
...
if __name__ == "__main__":
    model = ResNet(layers=50, output_size=(240, 320))
