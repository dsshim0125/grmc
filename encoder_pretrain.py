...
from data import MoCoData
from model.densedepth import MoCo as MoCo_densenet
from model.fcrn import MoCo as MoCo_resnet
from tqdm import tqdm


parser = argparse.ArgumentParser(description='PyTorch NYU Depth v2 Pretraining')
parser.add_argument('--encoder_type', default='densenet', type=str,help='model architecture')
...
def train(train_loader, model, criterion, optimizer1,optimizer2, epoch, args):
